...
import { getTypescriptEslintRules } from "../utils/typescript-eslint.js";
...
const tsEslintRules = getTypescriptEslintRules(baseJsRules, {
  overrides: {
    "@typescript-eslint/no-redeclare": [
      baseJsRules["no-redeclare"][0],
...
export const baseTs = defineConfig({
  name: "kit42/base/ts",
...
export const base = defineConfig([baseJs, baseTs]);
